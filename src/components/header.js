...
function Header() {
    ...
    return(
        <header ref={header} className='hide transition-all ease-in-out duration-1000 p-10 z-20 text-slate-100 flex justify-between sm:p-12 md:px-20 lg:pt-16 lg:px-40 absolute top-0 w-screen'>
