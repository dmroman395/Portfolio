...
function Header() {
    return(
        <header className='p-5 text-slate-100 flex justify-between sm:p-10 md:px-20 lg:pt-16 lg:px-40 absolute top-0 w-screen'>
            ...
            <ul className='flex text-xs font-normal sm:text-sm lg:text-base'>
                <li className='m-2'><a href='#moreInfo'>More Info</a></li>
                <li className='m-2'><a href='#projects'>Projects</a></li>
