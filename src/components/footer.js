    ...
    return (
        <footer className="bg-blue-500 p-10 h-screen flex flex-col justify-evenly">
            <div className="flex flex-col md:flex-row md:gap-14">
                <div className="flex flex-col justify-evenly md:max-w-[55%] lg:p-10 xl:p-12 xl:gap-20">
                ...
                <form action="https://formsubmit.co/4dbef3ded4ad3fba87469c1411c8dc69" method="POST" className="my-0 flex-grow" id='contact'>
