        ...
        <footer className="darkBg p-10 h-screen flex flex-col justify-evenly xl:p-40">
            <div className="flex flex-col md:flex-row md:gap-14 xl:gap-32">
                ...
                <form ref={form} action="https://formsubmit.co/414b72e79b006dc56f4fdace489834bb" method="POST" className="hideForm my-0 flex-grow mt-12 sm:mt-0" id='contact'>
                    ...
                    <input type="hidden" name="_next" value='https://www.davidmiguel.io/thankyou'/>
            ...
            <div className="flex justify-between xl:mt-32">
                ...
                <div className="flex gap-2">
                    <a href='https://github.com/dmroman395' target='_blank' rel="noreferrer"><Image src='/images/github.png' width={24} height={24} layout='fixed'/></a>
                    <a href='https://www.linkedin.com' target='_blank' rel="noreferrer"><Image src='/images/linkedin.png' width={24} height={24} layout='fixed'/></a>
                </div>
            </div>
        </footer>
    )
