...
function Hero() {
    return (
        <div className="h-screen flex flex-col justify-center relative">
            ...
            <Header/>
            <div className="backdrop-blur-md h-screen w-screen flex flex-col gap-5 justify-center px-10 py-24 md:px-20 lg:px-40 xl:px-72 z-10">
                <span className="text-sm max-w-fit font-medium bg-green-300 rounded py-1 px-3 sm:text-base md:font-normal">Front-End Developer</span>
